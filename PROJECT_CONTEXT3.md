...
> **УСТАРЕЛ с 2026-07-05.** Актуальный источник правды теперь живёт вне репозитория (чтобы не
> коммитить внутренние детали инфраструктуры/сервера в GitHub):
> `/Users/vova/telegram_bot/CAREERCHECK_CONTEXT.md`. Этот файл оставлен для истории, но
> реальный адрес сервера, схема деплоя и все изменения после этой даты — только там.
>
